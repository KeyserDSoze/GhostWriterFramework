 ...
 */
export type ChatCapability = "default" | "copilot" | "simple-tasks" | "review" | "deep-research" | "create-from-research";

export const CHAT_CAPABILITIES: ChatCapability[] = ["default", "copilot", "simple-tasks", "review", "deep-research", "create-from-research"];
...
export const ROUTING_TASKS: RoutingTaskKind[] = ["default", "copilot", "simple-tasks", "review", "deep-research", "create-from-research", "tts", "stt", "image"];
