...
function defaultWritingStyleBody(): string {
  return [
    ...
    "- Se un personaggio mostra un possibile tic ricorrente, usalo con parsimonia e solo se e coerente con il suo profilo psicologico; non trasformare ogni scena in una vetrina di tic.",
    "- Se un tic sembra davvero forte, prima osservalo in piu scene o mettilo nelle note del personaggio; solo dopo puoi stabilizzarlo nel canon del personaggio.",
    "",
