...
export declare function resolveContainedPath(rootPath: string, relativePath: string, label?: string): string;
export declare function assertContainedPath(rootPath: string, relativePath: string, label?: string): Promise<string>;
