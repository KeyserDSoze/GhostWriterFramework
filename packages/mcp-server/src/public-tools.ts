...
export function buildRepositorySpecSummary(): string {
  return [
    ...
    "",
    "- book.md",
    "- ghostwriters/<slug>.md for complete prose profiles selected by frontmatter",
    "- guidelines/",
    ...
    "- always use the selected ghostwriter profile while writing, revising, or reviewing prose; resolve paragraph, chapter, then book selection",
